  ...
  return (
    <>
      <nav className="fixed top-4 inset-x-0 px-6 md:px-16 z-50 flex items-center justify-between pointer-events-none">
        {/* Left: Logo */}
        <div className="w-[52px] h-[52px] rounded-full liquid-glass flex items-center justify-center pointer-events-auto shrink-0 relative z-50">
          <span className="font-heading italic text-[26px] leading-none pt-1">CV</span>
        </div>
        ...
        <div className="hidden md:block w-[52px] h-[52px] shrink-0"></div>
      </nav>
